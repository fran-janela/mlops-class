...
lambda_function_name = "get_polarity_franciscopj"
lambda_arn = "arn:aws:lambda:us-east-2:820926566402:function:get_polarity_franciscopj"

# Provide a name following the pattern `demo_polarity_<YOUR_INSPER_USERNAME>`
api_gateway_name = "demo-polarity-franciscopj"
